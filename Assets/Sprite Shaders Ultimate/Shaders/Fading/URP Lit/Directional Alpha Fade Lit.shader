...
Shader "Sprite Shaders Ultimate/URP Lit/Fading/Directional Alpha Fade Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _MainTex;
			sampler2D _DirectionalAlphaFadeNoiseTexture;
			sampler2D _MaskMap;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult2_g166 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g165 = 0;
				if( _DirectionalAlphaFadeSpace > 1.0 )
				ifLocalVar2_g165 = (ase_worldPos).xy;
				else if( _DirectionalAlphaFadeSpace == 1.0 )
				ifLocalVar2_g165 = (IN.ase_texcoord4.xyz).xy;
				else if( _DirectionalAlphaFadeSpace < 1.0 )
				ifLocalVar2_g165 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g166 ) );
				float2 temp_output_7_0_g163 = ifLocalVar2_g165;
				float3 rotatedValue136_g163 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_7_0_g163 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * PI ) );
				float3 break130_g163 = rotatedValue136_g163;
				float clampResult154_g163 = clamp( ( ( break130_g163.x + break130_g163.y + _DirectionalAlphaFadeFade + ( tex2D( _DirectionalAlphaFadeNoiseTexture, ( temp_output_7_0_g163 * _DirectionalAlphaFadeNoiseScale ) ).r * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g163 = (float4((temp_output_1_0_g163).rgb , ( temp_output_1_0_g163.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g163 ) ):( clampResult154_g163 )) )));
				
				float2 temp_output_8_0_g167 = IN.texCoord0.xy;
				
				float3 unpack14_g167 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g167 ), _NormalIntensity );
				unpack14_g167.z = lerp( 1, unpack14_g167.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult3_g163 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g167 ).r;
				float3 Normal = unpack14_g167;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g165 = (IN.ase_texcoord6.xyz).xy;
				else if( _DirectionalAlphaFadeSpace < 1.0 )
				ifLocalVar2_g165 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g166 ) );
				float2 temp_output_7_0_g163 = ifLocalVar2_g165;
				float3 rotatedValue136_g163 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_7_0_g163 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * PI ) );
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g165 = (IN.ase_texcoord3.xyz).xy;
				else if( _DirectionalAlphaFadeSpace < 1.0 )
				ifLocalVar2_g165 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g166 ) );
				float2 temp_output_7_0_g163 = ifLocalVar2_g165;
				float3 rotatedValue136_g163 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_7_0_g163 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * PI ) );
...
/*ASEBEGIN
Version=18800
179;83;1338;656;1605.461;773.777;2.498458;True;True
...
Node;AmplifyShaderEditor.FunctionNode;80;-288.7887,-366.1681;Inherit;False;_DirectionalAlphaFade;5;;163;65c65af0f3ba9814bae500501cf3b956;0;2;6;SAMPLER2D;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;66;23.38802,234.6282;Inherit;False;LitHandler;1;;167;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;76;33.67749,-128.6291;Inherit;False;TintVertex;-1;;168;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Fading/Directional Alpha Fade Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;68;0;69;0
WireConnection;80;6;69;0
...
ASEEND*/
//CHKSM=6FFBA89D12DAA142261DD276779EA5C041BA5308
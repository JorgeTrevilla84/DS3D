	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult2_g52 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g51 = 0;
				if( _SourceGlowDissolveSpace > 1.0 )
				ifLocalVar2_g51 = (ase_worldPos).xy;
				else if( _SourceGlowDissolveSpace == 1.0 )
				ifLocalVar2_g51 = (IN.ase_texcoord4.xyz).xy;
				else if( _SourceGlowDissolveSpace < 1.0 )
				ifLocalVar2_g51 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g52 ) );
				float2 temp_output_7_0_g50 = ifLocalVar2_g51;
				float temp_output_65_0_g50 = ( distance( _SourceGlowDissolvePosition , temp_output_7_0_g50 ) + ( tex2D( _SourceGlowDissolveNoiseTexture, ( temp_output_7_0_g50 * _SourceGlowDissolveNoiseScale ) ).r * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g50 = step( temp_output_65_0_g50 , _SourceGlowDissolveFade );
				float temp_output_76_0_g50 = step( temp_output_65_0_g50 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float2 uv_MainTex = IN.texCoord0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 temp_output_1_0_g50 = tex2D( _MainTex, uv_MainTex );
				float4 appendResult3_g50 = (float4(( ( max( ( temp_output_75_0_g50 - temp_output_76_0_g50 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g50).rgb ) , ( temp_output_1_0_g50.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g50 ) ):( temp_output_75_0_g50 )) )));
				...
				float4 Color = ( appendResult3_g50 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g51 = (IN.ase_texcoord6.xyz).xy;
				else if( _SourceGlowDissolveSpace < 1.0 )
				ifLocalVar2_g51 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g52 ) );
				float2 temp_output_7_0_g50 = ifLocalVar2_g51;
				float temp_output_65_0_g50 = ( distance( _SourceGlowDissolvePosition , temp_output_7_0_g50 ) + ( tex2D( _SourceGlowDissolveNoiseTexture, ( temp_output_7_0_g50 * _SourceGlowDissolveNoiseScale ) ).r * _SourceGlowDissolveNoiseFactor ) );
				...
				float4 Color = ( appendResult3_g50 * IN.color );
				float3 Normal = unpack14_g54;
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g51 = (IN.ase_texcoord3.xyz).xy;
				else if( _SourceGlowDissolveSpace < 1.0 )
				ifLocalVar2_g51 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g52 ) );
				float2 temp_output_7_0_g50 = ifLocalVar2_g51;
				float temp_output_65_0_g50 = ( distance( _SourceGlowDissolvePosition , temp_output_7_0_g50 ) + ( tex2D( _SourceGlowDissolveNoiseTexture, ( temp_output_7_0_g50 * _SourceGlowDissolveNoiseScale ) ).r * _SourceGlowDissolveNoiseFactor ) );
...
/*ASEBEGIN
Version=18800
93;246;1338;656;762.7637;426.6967;1.3;True;True
...
Node;AmplifyShaderEditor.FunctionNode;78;-364.3884,-397.2165;Inherit;False;_SourceGlowDissolve;5;;50;e9806b61110f4ef43ba237315c2a2b64;0;2;6;SAMPLER2D;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Fading/Source Glow Dissolve Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;68;0;69;0
WireConnection;78;6;69;0
...
ASEEND*/
//CHKSM=3E7A7F8C23AE840651D2EDD22DDBF0DD27004C97
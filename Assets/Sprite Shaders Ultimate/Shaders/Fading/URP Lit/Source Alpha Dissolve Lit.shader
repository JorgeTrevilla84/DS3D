...
Shader "Sprite Shaders Ultimate/URP Lit/Fading/Source Alpha Dissolve Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _MainTex;
			sampler2D _SourceAlphaDissolveNoiseTexture;
			sampler2D _MaskMap;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 ifLocalVar2_g47 = 0;
				if( _SourceAlphaDissolveSpace > 1.0 )
				ifLocalVar2_g47 = (ase_worldPos).xy;
				else if( _SourceAlphaDissolveSpace == 1.0 )
				ifLocalVar2_g47 = (IN.ase_texcoord4.xyz).xy;
				else if( _SourceAlphaDissolveSpace < 1.0 )
				ifLocalVar2_g47 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g48 ) );
				float2 temp_output_7_0_g46 = ifLocalVar2_g47;
				float clampResult17_g46 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_7_0_g46 ) + ( tex2D( _SourceAlphaDissolveNoiseTexture, ( temp_output_7_0_g46 * _SourceAlphaDissolveNoiseScale ) ).r * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g46 = (float4((temp_output_1_0_g46).rgb , ( temp_output_1_0_g46.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g46 ) ):( clampResult17_g46 )) )));
				...
				float4 Color = ( appendResult3_g46 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g47 = (IN.ase_texcoord6.xyz).xy;
				else if( _SourceAlphaDissolveSpace < 1.0 )
				ifLocalVar2_g47 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g48 ) );
				float2 temp_output_7_0_g46 = ifLocalVar2_g47;
				float clampResult17_g46 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_7_0_g46 ) + ( tex2D( _SourceAlphaDissolveNoiseTexture, ( temp_output_7_0_g46 * _SourceAlphaDissolveNoiseScale ) ).r * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				...
				float4 Color = ( appendResult3_g46 * IN.color );
				float3 Normal = unpack14_g21;
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g47 = (IN.ase_texcoord3.xyz).xy;
				else if( _SourceAlphaDissolveSpace < 1.0 )
				ifLocalVar2_g47 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g48 ) );
				float2 temp_output_7_0_g46 = ifLocalVar2_g47;
				float clampResult17_g46 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_7_0_g46 ) + ( tex2D( _SourceAlphaDissolveNoiseTexture, ( temp_output_7_0_g46 * _SourceAlphaDissolveNoiseScale ) ).r * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18800
93;246;1338;656;1029.057;559.9167;1.263873;True;True
...
Node;AmplifyShaderEditor.FunctionNode;75;-252.1942,-366.2661;Inherit;False;_SourceAlphaDissolve;5;;46;75f1c89deee2e424a880fee4d93b50a3;0;2;6;SAMPLER2D;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;76;33.67749,-128.6291;Inherit;False;TintVertex;-1;;162;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Fading/Source Alpha Dissolve Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;68;0;69;0
WireConnection;75;6;69;0
...
ASEEND*/
//CHKSM=422A177594B6A24154380E54F8A8069D6D50579E
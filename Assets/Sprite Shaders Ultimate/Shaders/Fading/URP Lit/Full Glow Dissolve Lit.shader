...
Shader "Sprite Shaders Ultimate/URP Lit/Fading/Full Glow Dissolve Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _FullGlowDissolveNoiseTexture;
			sampler2D _MainTex;
			sampler2D _MaskMap;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult2_g45 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g44 = 0;
				if( _FullGlowDissolveSpace > 1.0 )
				ifLocalVar2_g44 = (ase_worldPos).xy;
				else if( _FullGlowDissolveSpace == 1.0 )
				ifLocalVar2_g44 = (IN.ase_texcoord4.xyz).xy;
				else if( _FullGlowDissolveSpace < 1.0 )
				ifLocalVar2_g44 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g45 ) );
				float temp_output_5_0_g42 = tex2D( _FullGlowDissolveNoiseTexture, ( ifLocalVar2_g44 * _FullGlowDissolveNoiseScale ) ).r;
				float temp_output_61_0_g42 = step( temp_output_5_0_g42 , _FullGlowDissolveFade );
				float temp_output_53_0_g42 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float2 uv_MainTex = IN.texCoord0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 temp_output_1_0_g42 = tex2D( _MainTex, uv_MainTex );
				float4 appendResult3_g42 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g42 - step( temp_output_5_0_g42 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g42 ) ) - temp_output_53_0_g42 ) ) ) ) + (temp_output_1_0_g42).rgb ) , ( temp_output_1_0_g42.a * temp_output_61_0_g42 )));
				...
				float4 Color = ( appendResult3_g42 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g44 = (IN.ase_texcoord6.xyz).xy;
				else if( _FullGlowDissolveSpace < 1.0 )
				ifLocalVar2_g44 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g45 ) );
				float temp_output_5_0_g42 = tex2D( _FullGlowDissolveNoiseTexture, ( ifLocalVar2_g44 * _FullGlowDissolveNoiseScale ) ).r;
				float temp_output_61_0_g42 = step( temp_output_5_0_g42 , _FullGlowDissolveFade );
				...
				float4 Color = ( appendResult3_g42 * IN.color );
				float3 Normal = unpack14_g21;
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g44 = (IN.ase_texcoord3.xyz).xy;
				else if( _FullGlowDissolveSpace < 1.0 )
				ifLocalVar2_g44 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g45 ) );
				float temp_output_5_0_g42 = tex2D( _FullGlowDissolveNoiseTexture, ( ifLocalVar2_g44 * _FullGlowDissolveNoiseScale ) ).r;
				float temp_output_61_0_g42 = step( temp_output_5_0_g42 , _FullGlowDissolveFade );
...
/*ASEBEGIN
Version=18800
93;246;1338;656;1643.009;880.8096;1.934374;True;True
...
Node;AmplifyShaderEditor.FunctionNode;74;-397.2719,-387.5441;Inherit;False;_FullGlowDissolve;5;;42;8ddf4a66b5da487489c0831f7f85d466;0;2;6;SAMPLER2D;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;75;-64.55992,-192.1724;Inherit;False;TintVertex;-1;;162;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Fading/Full Glow Dissolve Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;68;0;69;0
WireConnection;74;6;69;0
...
ASEEND*/
//CHKSM=A80AEBFE8F3A404A08EAD49448B421C66E3A3A58
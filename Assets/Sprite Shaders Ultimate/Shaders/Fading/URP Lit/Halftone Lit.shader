...
Shader "Sprite Shaders Ultimate/URP Lit/Fading/Halftone Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult2_g165 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g164 = 0;
				if( _HalftoneSpace > 1.0 )
				ifLocalVar2_g164 = (ase_worldPos).xy;
				else if( _HalftoneSpace == 1.0 )
				ifLocalVar2_g164 = (IN.ase_texcoord4.xyz).xy;
				else if( _HalftoneSpace < 1.0 )
				ifLocalVar2_g164 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g165 ) );
				float2 temp_output_7_0_g163 = ifLocalVar2_g164;
				float temp_output_121_0_g163 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_7_0_g163 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g166 = (float2(temp_output_121_0_g163 , temp_output_121_0_g163));
				float temp_output_17_0_g166 = length( ( (( ( abs( temp_output_7_0_g163 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g166 ) );
				float clampResult17_g163 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g166 ) / fwidth( temp_output_17_0_g166 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g163 = (float4((temp_output_1_0_g163).rgb , ( temp_output_1_0_g163.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g163 ) ):( clampResult17_g163 )) )));
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g164 = (IN.ase_texcoord6.xyz).xy;
				else if( _HalftoneSpace < 1.0 )
				ifLocalVar2_g164 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g165 ) );
				float2 temp_output_7_0_g163 = ifLocalVar2_g164;
				float temp_output_121_0_g163 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_7_0_g163 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g164 = (IN.ase_texcoord3.xyz).xy;
				else if( _HalftoneSpace < 1.0 )
				ifLocalVar2_g164 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g165 ) );
				float2 temp_output_7_0_g163 = ifLocalVar2_g164;
				float temp_output_121_0_g163 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_7_0_g163 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
...
/*ASEBEGIN
Version=18800
75;294;1338;644;793.679;489.0465;1.124337;True;True
...
Node;AmplifyShaderEditor.FunctionNode;80;-380.5668,-384.7888;Inherit;False;_Halftone;5;;163;ca4cfbb80c2060a468153c564b58606b;0;2;6;SAMPLER2D;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;79;-36.3372,-172.4588;Inherit;False;TintVertex;-1;;168;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=B7019B0F24F069EAF0F567A50DBCFC6AF4CC2AFD
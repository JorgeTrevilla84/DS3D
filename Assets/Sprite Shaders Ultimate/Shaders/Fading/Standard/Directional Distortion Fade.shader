	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 appendResult2_g337 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g336 = 0;
				if( _DirectionalDistortionSpace > 1.0 )
				ifLocalVar2_g336 = (ase_worldPos).xy;
				else if( _DirectionalDistortionSpace == 1.0 )
				ifLocalVar2_g336 = (IN.ase_texcoord2.xyz).xy;
				else if( _DirectionalDistortionSpace < 1.0 )
				ifLocalVar2_g336 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g337 ) );
				float2 temp_output_7_0_g334 = ifLocalVar2_g336;
				float3 rotatedValue168_g334 = RotateAroundAxis( float3( 0,0,0 ), float3( _DirectionalDistortionDistortion ,  0.0 ), float3( 0,0,1 ), ( ( ( tex2D( _DirectionalDistortionNoiseTexture, ( temp_output_7_0_g334 * _DirectionalDistortionDistortionScale ) ).r - 0.5 ) * 2.0 * _DirectionalDistortionRandomDirection ) * UNITY_PI ) );
				float3 rotatedValue136_g334 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_7_0_g334 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalDistortionRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g334 = rotatedValue136_g334;
				float clampResult154_g334 = clamp( ( ( break130_g334.x + break130_g334.y + _DirectionalDistortionFade + ( tex2D( _DirectionalDistortionNoiseTexture, ( temp_output_7_0_g334 * _DirectionalDistortionNoiseScale ) ).r * _DirectionalDistortionNoiseFactor ) ) / max( _DirectionalDistortionWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 break4_g340 = tex2D( _MainTex, ( texCoord111 + ( (rotatedValue168_g334).xy * ( 1.0 - (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g334 ) ):( clampResult154_g334 )) ) ) ) );
				float4 appendResult5_g340 = (float4(break4_g340.r , break4_g340.g , break4_g340.b , ( break4_g340.a * (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g334 ) ):( clampResult154_g334 )) )));
...
/*ASEBEGIN
Version=18800
-29;704;1613;672;1794.651;315.2453;1.381038;True;True
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;41;-1319.945,-379.2409;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;125;-991.5547,-358.9141;Inherit;False;_DirectionalDistortion;0;;334;30e6ac39427ee11419083602d572972f;0;3;160;FLOAT2;0,0;False;181;SAMPLER2D;;False;6;SAMPLER2D;0;False;2;FLOAT2;174;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;388.115,-98.37991;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;8;Sprite Shaders Ultimate/Standard/Fading/Directional Distortion;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;3;1;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;True;2;False;-1;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
WireConnection;125;160;111;0
WireConnection;125;6;41;0
WireConnection;17;0;41;0
WireConnection;17;1;125;174
WireConnection;112;1;17;0
WireConnection;112;2;125;0
WireConnection;87;1;112;0
WireConnection;14;0;87;0
ASEEND*/
//CHKSM=1E228F0D3090BA06A4FC73FE8D801B6231C5CAE6
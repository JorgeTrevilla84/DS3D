...
Shader "Sprite Shaders Ultimate/Standard/Fading/Full Alpha Dissolve"
{
	Properties
	{
		...
		_FullAlphaDissolveNoiseTexture("Full Alpha Dissolve: Noise Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 temp_output_1_0_g105 = tex2D( _MainTex, uv_MainTex );
				float temp_output_53_0_g105 = max( _FullAlphaDissolveWidth , 0.001 );
				float3 ase_worldPos = IN.ase_texcoord1.xyz;
				float2 appendResult2_g107 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g106 = 0;
				if( _FullAlphaDissolveSpace > 1.0 )
				ifLocalVar2_g106 = (ase_worldPos).xy;
				else if( _FullAlphaDissolveSpace == 1.0 )
				ifLocalVar2_g106 = (IN.ase_texcoord2.xyz).xy;
				else if( _FullAlphaDissolveSpace < 1.0 )
				ifLocalVar2_g106 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g107 ) );
				float clampResult17_g105 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g105 ) ) - tex2D( _FullAlphaDissolveNoiseTexture, ( ifLocalVar2_g106 * _FullAlphaDissolveNoiseScale ) ).r ) / temp_output_53_0_g105 ) , 0.0 , 1.0 );
				float4 appendResult3_g105 = (float4((temp_output_1_0_g105).rgb , ( temp_output_1_0_g105.a * clampResult17_g105 )));
				
				fixed4 c = ( appendResult3_g105 * IN.color );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=18800
93;246;1338;656;1454.535;493.8706;2.476427;True;True
...
Node;AmplifyShaderEditor.FunctionNode;73;-167.6121,-57.51434;Inherit;False;_FullAlphaDissolve;0;;105;f3e6b1997d56ebb4981b48e726056198;0;2;6;SAMPLER2D;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
WireConnection;73;6;41;0
WireConnection;73;1;17;0
WireConnection;74;1;73;0
WireConnection;14;0;74;0
ASEEND*/
//CHKSM=41C4098C1E56E4B4821DE938AE04031AF3A2AB63
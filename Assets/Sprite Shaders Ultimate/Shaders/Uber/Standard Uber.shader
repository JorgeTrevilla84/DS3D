	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 break77_g2326 = texCoord39;
				float2 appendResult72_g2326 = (float2(( _SquishStretch * ( break77_g2326.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g2326.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH_ON
				float2 staticSwitch96 = ( appendResult72_g2326 + float2( 0,0 ) );
				#else
				float2 staticSwitch96 = float2( 0,0 );
				#endif
				float2 temp_output_2_0_g2364 = staticSwitch96;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g2364 = ( ( sin( ( _Time.y * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g2364 );
				#else
				float2 staticSwitch4_g2364 = temp_output_2_0_g2364;
				#endif
				float mulTime27_g2366 = _Time.y * _VibrateFrequency;
				float3 rotatedValue21_g2366 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( _VibrateRotation * _Time.y ) );
				#ifdef _ENABLEVIBRATE_ON
				float2 staticSwitch6_g2364 = ( ( sin( mulTime27_g2366 ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g2366).xy ) + staticSwitch4_g2364 );
				#else
				float2 staticSwitch6_g2364 = staticSwitch4_g2364;
				#endif
				float fullFade123 = _FullFade;
				float2 lerpResult121 = lerp( float2( 0,0 ) , staticSwitch6_g2364 , fullFade123);
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				fixed4 c = ( lerpResult125 * lerpResult126 );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=18800
80;40;1331;672;-4646.608;-6.25705;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;97;4200.187,769.8402;Inherit;False;_Squish;411;;2326;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;92;4760.852,615.6682;Inherit;False;_UberTransformOffset;382;;2364;ee5e9e731457b2342bdb306bdb8d2401;0;1;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;5405.575,239.1301;Float;False;True;-1;2;SpriteShadersUltimate.UberShaderGUI;0;8;Sprite Shaders Ultimate/Uber/Standard Uber;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;3;1;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;True;2;False;-1;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=177D82CB74B5B7B94D678064FB8D4F41B41A9FB1
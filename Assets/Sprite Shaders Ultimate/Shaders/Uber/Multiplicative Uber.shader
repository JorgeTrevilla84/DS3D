	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 break77_g2364 = texCoord39;
				float2 appendResult72_g2364 = (float2(( _SquishStretch * ( break77_g2364.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g2364.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH_ON
				float2 staticSwitch96 = ( appendResult72_g2364 + float2( 0,0 ) );
				#else
				float2 staticSwitch96 = float2( 0,0 );
				#endif
				float2 temp_output_2_0_g2365 = staticSwitch96;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g2365 = ( ( sin( ( _Time.y * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g2365 );
				#else
				float2 staticSwitch4_g2365 = temp_output_2_0_g2365;
				#endif
				float mulTime27_g2367 = _Time.y * _VibrateFrequency;
				float3 rotatedValue21_g2367 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( _VibrateRotation * _Time.y ) );
				...
				IN.vertex.xyz += float3( lerpResult121 ,  0.0 ); 
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 transform62_g1176 = mul(unity_WorldToObject,float4( 0,0,0,1 ));
				float gradientNoise95_g1176 = GradientNoise(( ( (transform62_g1176).xy + ( _Time.y * WindNoiseSpeed ) ) * WindNoiseScale ),0.05);
				...
				ifLocalVar2_g1177 = (IN.ase_texcoord2.xyz).xy;
				else if( 1 < 1.0 )
				ifLocalVar2_g1177 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g1178 ) );
				float lerpResult78_g1176 = lerp( 1.0 , lerpResult86_g1176 , _WindDistortionWindFactor);
				float2 lerpResult75_g1176 = lerp( _WindFromDistortion , _WindToDistortion , ( tex2D( _UberNoiseTexture, ( ( ifLocalVar2_g1177 + ( _Time.y * _WindDistortionSpeed ) ) * _WindDistortionScale ) ).r * lerpResult78_g1176 ));
				...
				ifLocalVar2_g1183 = (IN.ase_texcoord2.xyz).xy;
				else if( _UVDistortSpace < 1.0 )
				ifLocalVar2_g1183 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g1184 ) );
				float2 lerpResult21_g1182 = lerp( _UVDistortFrom , _UVDistortTo , tex2D( _UberNoiseTexture, ( ( ifLocalVar2_g1183 + ( _UVDistortSpeed * _Time.y ) ) * _UVDistortNoiseScale ) ).r);
				...
				#endif
				float mulTime43_g1189 = _Time.y * _SineRotateFrequency;
				float3 rotatedValue36_g1189 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g1181 ,  0.0 ), float3( 0,0,1 ), ( sin( mulTime43_g1189 ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				...
				#endif
				float mulTime6_g1190 = _Time.y * _UVRotateSpeed;
				float3 rotatedValue8_g1190 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g1181 ,  0.0 ), float3( 0,0,1 ), ( mulTime6_g1190 * UNITY_PI ) );
				...
				float2 staticSwitch14_g1181 = ( ( ( _UVScrollSpeed * _Time.y ) + staticSwitch16_g1181 ) % float2( 1,1 ) );
				#else
				...
				ifLocalVar2_g1197 = (IN.ase_texcoord2.xyz).xy;
				else if( _FullDistortionSpace < 1.0 )
				ifLocalVar2_g1197 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g1198 ) );
				...
				ifLocalVar2_g1201 = (IN.ase_texcoord2.xyz).xy;
				else if( _DirectionalDistortionSpace < 1.0 )
				ifLocalVar2_g1201 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g1202 ) );
				float2 temp_output_7_0_g1199 = ifLocalVar2_g1201;
				float3 rotatedValue168_g1199 = RotateAroundAxis( float3( 0,0,0 ), float3( _DirectionalDistortionDistortion ,  0.0 ), float3( 0,0,1 ), ( ( ( tex2D( _UberNoiseTexture, ( temp_output_7_0_g1199 * _DirectionalDistortionDistortionScale ) ).r - 0.5 ) * 2.0 * _DirectionalDistortionRandomDirection ) * UNITY_PI ) );
				float3 rotatedValue136_g1199 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_7_0_g1199 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalDistortionRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				...
				#endif
				float temp_output_8_0_g1205 = ( ( ( _Time.y * _HologramDistortionSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y );
				...
				ifLocalVar2_g1335 = (IN.ase_texcoord2.xyz).xy;
				else if( _GlitchSpace < 1.0 )
				ifLocalVar2_g1335 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g1336 ) );
				float2 temp_output_3_0_g1334 = ifLocalVar2_g1335;
				float2 temp_output_102_0 = temp_output_3_0_g1334;
				float temp_output_102_15 = ( max( tex2D( _UberNoiseTexture, ( ( temp_output_3_0_g1334 + ( _GlitchMaskSpeed * _Time.y ) ) * _GlitchMaskScale ) ).r , _GlitchMaskMin ) * _GlitchFade );
				...
				float clampResult70_g2202 = clamp( ( ( ( tex2D( _UberNoiseTexture, ( ( ( _Time.y * _FlameSpeed ) + temp_output_75_0_g2202 ) * _FlameNoiseScale ) ).r * pow( saferPower57_g2202 , _FlameNoiseHeightFactor ) * _FlameNoiseFactor ) + ( ( temp_output_47_0_g2202 - distance( temp_output_75_0_g2202 , float2( 0.5,0.4 ) ) ) / temp_output_47_0_g2202 ) ) * _FlameSmooth ) , 0.0 , 1.0 );
				...
				float3 lerpResult26_g2230 = lerp( (temp_output_1_0_g2230).rgb , ( appendResult56_g2230 * pow( ( ( break2_g2231.x + break2_g2231.y + break2_g2231.z ) / 3.0 ) , max( ( break55_g2230.a * 2.0 ) , 0.01 ) ) ) , ( hsvTorgb33_g2230.z * _RecolorFade ));
				...
				ifLocalVar2_g2228 = (IN.ase_texcoord2.xyz).xy;
				else if( _InkSpreadSpace < 1.0 )
				ifLocalVar2_g2228 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2229 ) );
				...
				float mulTime31_g2222 = _Time.y * _ShiftHueSpeed;
				...
				#endif
				float mulTime28_g2218 = _Time.y * _AddHueSpeed;
				...
				float4 break2_g2221 = temp_output_1_0_g2218;
				float2 uv_AddHueShaderMask = IN.texcoord.xy * _AddHueShaderMask_ST.xy + _AddHueShaderMask_ST.zw;
				float4 tex2DNode3_g2220 = tex2D( _AddHueShaderMask, uv_AddHueShaderMask );
				float4 appendResult6_g2218 = (float4(( ( hsvTorgb19_g2218 * pow( ( ( break2_g2221.x + break2_g2221.y + break2_g2221.z ) / 3.0 ) , max( _AddHueContrast , 0.001 ) ) * ( _AddHueFade * ( tex2DNode3_g2220.r * tex2DNode3_g2220.a ) ) ) + (temp_output_1_0_g2218).rgb ) , temp_output_1_0_g2218.a));
				...
				float mulTime15_g2209 = _Time.y * _SineGlowFrequency;
				...
				float2 staticSwitch169_g2213 = ( ( tex2D( _UberNoiseTexture, ( ( ( _Time.y * _InnerOutlineNoiseSpeed ) + temp_output_7_0_g2213 ) * _InnerOutlineNoiseScale ) ).r - 0.25 ) * _InnerOutlineDistortionIntensity );
				#else
				...
				float2 staticSwitch157_g2232 = ( ( tex2D( _UberNoiseTexture, ( ( ( _Time.y * _OuterOutlineNoiseSpeed ) + temp_output_7_0_g2232 ) * _OuterOutlineNoiseScale ) ).r - 0.25 ) * _OuterOutlineDistortionIntensity );
				#else
				...
				float4 appendResult22_g2238 = (float4(( (_HologramTint).rgb * pow( saferPower7_g2240 , temp_output_9_0_g2240 ) ) , ( max( pow( abs( sin( ( ( ( ( _Time.y * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g2238.a )));
				...
				float mulTime14_g2241 = _Time.y * _GlitchHueSpeed;
				float3 hsvTorgb3_g2244 = HSVToRGB( float3(( tex2D( _UberNoiseTexture, ( ( temp_output_102_0 + ( _GlitchNoiseSpeed * _Time.y ) ) * _GlitchNoiseScale ) ).r + mulTime14_g2241 ),1.0,1.0) );
				...
				ifLocalVar2_g2279 = (IN.ase_texcoord2.xyz).xy;
				else if( _MetalSpace < 1.0 )
				ifLocalVar2_g2279 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2280 ) );
				...
				float4 lerpResult45_g2273 = lerp( temp_output_1_0_g2273 , ( ( max( ( ( _MetalHighlightDensity - tex2D( _UberNoiseTexture, ( ( ( ( tex2D( _UberNoiseTexture, ( ( ( _Time.y * _MetalNoiseDistortionSpeed ) + temp_output_16_0_g2273 ) * _MetalNoiseDistortionScale ) ).r - 0.25 ) * _MetalNoiseDistortion ) + ( ( _Time.y * _MetalNoiseSpeed ) + temp_output_16_0_g2273 ) ) * _MetalNoiseScale ) ).r ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( saferPower7_g2277 , temp_output_9_0_g2277 ) ) + ( pow( saferPower2_g2273 , _MetalContrast ) * _MetalColor ) ) , ( _MetalFade * ( tex2DNode3_g2278.r * tex2DNode3_g2278.a ) ));
				...
				float4 break2_g2266 = temp_output_1_0_g2265;
				float temp_output_7_0_g2265 = ( ( break2_g2266.x + break2_g2266.y + break2_g2266.z ) / 3.0 );
				float temp_output_9_0_g2270 = max( _FrozenContrast , 0.0 );
				float saferPower7_g2270 = max( ( temp_output_7_0_g2265 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g2270 ) , 0.0 ) ) ) , 0.0001 );
				float2 appendResult2_g2269 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g2268 = 0;
				if( _FrozenSpace > 1.0 )
				ifLocalVar2_g2268 = (ase_worldPos).xy;
				else if( _FrozenSpace == 1.0 )
				ifLocalVar2_g2268 = (IN.ase_texcoord2.xyz).xy;
				else if( _FrozenSpace < 1.0 )
				ifLocalVar2_g2268 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2269 ) );
				float2 temp_output_3_0_g2265 = ifLocalVar2_g2268;
				float saferPower42_g2265 = max( temp_output_7_0_g2265 , 0.0001 );
				float3 lerpResult57_g2265 = lerp( (temp_output_1_0_g2265).rgb , ( ( pow( saferPower7_g2270 , temp_output_9_0_g2270 ) * (_FrozenTint).rgb ) + ( pow( temp_output_7_0_g2265 , _FrozenSnowContrast ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - tex2D( _UberNoiseTexture, ( temp_output_3_0_g2265 * _FrozenSnowScale ) ).r ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - tex2D( _UberNoiseTexture, ( ( ( ( tex2D( _UberNoiseTexture, ( ( ( _Time.y * _FrozenHighlightDistortionSpeed ) + temp_output_3_0_g2265 ) * _FrozenHighlightDistortionScale ) ).r - 0.25 ) * _FrozenHighlightDistortion ) + ( ( _Time.y * _FrozenHighlightSpeed ) + temp_output_3_0_g2265 ) ) * _FrozenHighlightScale ) ).r ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( saferPower42_g2265 , _FrozenHighlightContrast ) )).rgb ) , _FrozenFade);
				...
				ifLocalVar2_g2262 = (IN.ase_texcoord2.xyz).xy;
				else if( (int)_BurnSpace < 1.0 )
				ifLocalVar2_g2262 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2263 ) );
				...
				ifLocalVar2_g2256 = (IN.ase_texcoord2.xyz).xy;
				else if( (int)_RainbowSpace < 1.0 )
				ifLocalVar2_g2256 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2257 ) );
				float2 temp_output_3_0_g2251 = ifLocalVar2_g2256;
				float mulTime14_g2251 = _Time.y * _RainbowSpeed;
				...
				float mulTime86_g2246 = _Time.y * _ShineSpeed;
				...
				ifLocalVar2_g2248 = (IN.ase_texcoord2.xyz).xy;
				else if( _ShineSpace < 1.0 )
				ifLocalVar2_g2248 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2249 ) );
				float3 rotatedValue69_g2246 = RotateAroundAxis( float3( 0,0,0 ), float3( ( mulTime86_g2246 + ( _ShineScale * ifLocalVar2_g2248 ) ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 360.0 ) * UNITY_PI ) );
				...
				float4 appendResult8_g2246 = (float4(( (temp_output_1_0_g2246).rgb + ( ( pow( ( ( break2_g2247.x + break2_g2247.y + break2_g2247.z ) / 3.0 ) , max( _ShineContrast , 0.001 ) ) * (_ShineColor).rgb ) * clampResult80_g2246 * ( _ShineFade * ( tex2DNode3_g2250.r * tex2DNode3_g2250.a ) ) ) ) , (temp_output_1_0_g2246).a));
				...
				ifLocalVar2_g2292 = (IN.ase_texcoord2.xyz).xy;
				else if( (int)_PoisonSpace < 1.0 )
				ifLocalVar2_g2292 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2293 ) );
				float mulTime15_g2290 = _Time.y * _PoisonShiftSpeed;
				float saferPower19_g2290 = max( abs( ( ( ( tex2D( _UberNoiseTexture, ( ( ( _Time.y * _PoisonNoiseSpeed ) + ifLocalVar2_g2292 ) * _PoisonNoiseScale ) ).r + mulTime15_g2290 ) % 1.0 ) + -0.5 ) ) , 0.0001 );
				...
				ifLocalVar2_g2330 = (IN.ase_texcoord2.xyz).xy;
				else if( _FullAlphaDissolveSpace < 1.0 )
				ifLocalVar2_g2330 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2331 ) );
				...
				ifLocalVar2_g2341 = (IN.ase_texcoord2.xyz).xy;
				else if( _FullGlowDissolveSpace < 1.0 )
				ifLocalVar2_g2341 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2342 ) );
				...
				ifLocalVar2_g2338 = (IN.ase_texcoord2.xyz).xy;
				else if( _SourceAlphaDissolveSpace < 1.0 )
				ifLocalVar2_g2338 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2339 ) );
				...
				ifLocalVar2_g2345 = (IN.ase_texcoord2.xyz).xy;
				else if( _SourceGlowDissolveSpace < 1.0 )
				ifLocalVar2_g2345 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2346 ) );
				...
				ifLocalVar2_g2354 = (IN.ase_texcoord2.xyz).xy;
				else if( _DirectionalAlphaFadeSpace < 1.0 )
				ifLocalVar2_g2354 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2355 ) );
				float2 temp_output_7_0_g2352 = ifLocalVar2_g2354;
				float3 rotatedValue136_g2352 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_7_0_g2352 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				...
				ifLocalVar2_g2350 = (IN.ase_texcoord2.xyz).xy;
				else if( _DirectionalGlowFadeSpace < 1.0 )
				ifLocalVar2_g2350 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2351 ) );
				float2 temp_output_7_0_g2348 = ifLocalVar2_g2350;
				float3 rotatedValue136_g2348 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_7_0_g2348 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				...
				ifLocalVar2_g2334 = (IN.ase_texcoord2.xyz).xy;
				else if( _HalftoneSpace < 1.0 )
				ifLocalVar2_g2334 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g2335 ) );
				...
				#endif
				float4 temp_output_1_0_g2357 = staticSwitch13_g2327;
				float4 break2_g2359 = temp_output_1_0_g2357;
				float temp_output_9_0_g2358 = max( _AddColorContrast , 0.0 );
				float saferPower7_g2358 = max( ( ( ( break2_g2359.x + break2_g2359.y + break2_g2359.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g2358 ) , 0.0 ) ) ) , 0.0001 );
				float4 appendResult6_g2357 = (float4(( ( (_AddColorColor).rgb * pow( saferPower7_g2358 , temp_output_9_0_g2358 ) * _AddColorFade ) + (temp_output_1_0_g2357).rgb ) , temp_output_1_0_g2357.a));
				#ifdef _ENABLEADDCOLOR_ON
				float4 staticSwitch5_g2356 = appendResult6_g2357;
				#else
				float4 staticSwitch5_g2356 = staticSwitch13_g2327;
				#endif
				float4 temp_output_1_0_g2360 = staticSwitch5_g2356;
				float saferPower11_g2360 = max( ( 1.0 - temp_output_1_0_g2360.a ) , 0.0001 );
				float3 lerpResult4_g2360 = lerp( (temp_output_1_0_g2360).rgb , (_AlphaTintColor).rgb , ( pow( saferPower11_g2360 , _AlphaTintPower ) * _AlphaTintFade * step( _AlphaTintMinAlpha , temp_output_1_0_g2360.a ) ));
				float4 appendResult13_g2360 = (float4(lerpResult4_g2360 , temp_output_1_0_g2360.a));
				#ifdef _ENABLEALPHATINT_ON
				float4 staticSwitch11_g2356 = appendResult13_g2360;
				#else
				float4 staticSwitch11_g2356 = staticSwitch5_g2356;
				#endif
				float4 temp_output_1_0_g2361 = staticSwitch11_g2356;
				float4 break2_g2362 = temp_output_1_0_g2361;
				float temp_output_9_0_g2363 = max( _StrongTintContrast , 0.0 );
				float saferPower7_g2363 = max( ( ( ( break2_g2362.x + break2_g2362.y + break2_g2362.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g2363 ) , 0.0 ) ) ) , 0.0001 );
				float3 lerpResult7_g2361 = lerp( (temp_output_1_0_g2361).rgb , ( pow( saferPower7_g2363 , temp_output_9_0_g2363 ) * (_StrongTintTint).rgb ) , _StrongTintFade);
				float4 appendResult9_g2361 = (float4(lerpResult7_g2361 , (temp_output_1_0_g2361).a));
				#ifdef _ENABLESTRONGTINT_ON
				float4 staticSwitch7_g2356 = appendResult9_g2361;
				#else
				float4 staticSwitch7_g2356 = staticSwitch11_g2356;
				#endif
				float4 lerpResult125 = lerp( tex2DNode31 , staticSwitch7_g2356 , fullFade123);
				...
				float3 lerpResult134 = lerp( float3( 1,1,1 ) , (temp_output_119_0).rgb , temp_output_119_0.a);
				float4 appendResult135 = (float4(lerpResult134 , 1.0));
				
				fixed4 c = appendResult135;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=18800
89;129;1331;672;-5535.043;-133.6371;1;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;101;-7164.425,-997.4631;Inherit;True;Property;_UberNoiseTexture;Uber Noise Texture;1;0;Create;True;0;0;0;False;0;False;6b7b4a61603088549ac748de5e4e6d8c;6b7b4a61603088549ac748de5e4e6d8c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;30;-7196.071,-37.33487;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;95;-6086.266,-1877.294;Inherit;False;_UberInteractive;394;;1175;f8a4d7008519ad249b29e4a9381f963f;0;3;9;SAMPLER2D;0,0;False;2;SAMPLER2D;0;False;3;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;93;-5726.133,-1869.814;Inherit;False;_UberTransformUV;346;;1181;894b1de51a5f4c74cbe7828262f1344b;0;3;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RelayNode;84;-5455.61,-1860.612;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;79;-4821.681,-1346.285;Inherit;False;_FullDistortion;340;;1194;62960fe27c1c398408207bb462ffd10e;0;3;160;FLOAT2;0,0;False;194;SAMPLER2D;;False;6;SAMPLER2D;0;False;2;FLOAT2;174;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;83;-4439.266,-1465.582;Inherit;False;Property;_EnableShine;Enable Shine;339;0;Create;True;0;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Reference;77;True;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;81;-4047.438,-1306.412;Inherit;False;_DirectionalDistortion;327;;1199;30e6ac39427ee11419083602d572972f;0;3;160;FLOAT2;0,0;False;181;SAMPLER2D;;False;6;SAMPLER2D;0;False;2;FLOAT2;174;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;82;-3730.236,-1441.193;Inherit;False;Property;_EnableShine;Enable Shine;326;0;Create;True;0;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Reference;75;True;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-3011.915,-1200.063;Inherit;False;Property;_HologramFade;Hologram: Fade;115;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RelayNode;38;-3256.692,-1121.087;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;52;-2856.382,-933.5969;Inherit;False;_HologramUV;123;;1205;7c71b1b031ffcbe48805e17b94671163;0;4;55;FLOAT;0;False;76;SAMPLER2D;;False;37;FLOAT2;0,0;False;39;SAMPLER2D;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;102;-2340.493,-1142.616;Inherit;False;_GlitchPre;130;;1334;b8ad29d751d87bd4d9cbf14898be6163;0;2;1;SAMPLER2D;0,0;False;16;SAMPLER2D;;False;2;FLOAT;15;FLOAT2;0
Node;AmplifyShaderEditor.StaticSwitch;59;-2453.853,-1017.059;Inherit;False;Property;_EnableShine;Enable Shine;114;0;Create;True;0;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Reference;56;True;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;122;4180.248,1061.212;Inherit;False;Property;_FullFade;Full Fade;0;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;103;-2101.074,-915.8625;Inherit;False;_GlitchUV;143;;1338;2addb21417fb5d745a5abfe02cbcd453;0;4;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.StaticSwitch;62;-1753.86,-988.5486;Inherit;False;Property;_EnableShine;Enable Shine;129;0;Create;True;0;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Reference;57;True;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;120;-737.796,35.8288;Inherit;False;_UberCustomAlpha;431;;2195;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;COLOR;12;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;115;-404.7228,-125.1053;Inherit;False;_UberGenerated;416;;2200;52defa3f7cca25740a6a77f065edb382;0;3;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;108;-136.8644,-329.1863;Inherit;False;_UberColor;19;;2204;db48f560e502b78409f7fbe481a93597;0;4;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;116;;2238;76082a965d84d0e4da33b2cff51b3691;0;2;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;56;488.4655,-401.1591;Inherit;False;Property;_EnableHologram;Enable Hologram;114;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;104;891.7633,-197.4055;Inherit;False;_Glitch;137;;2241;97a01281f94bcc04fbb9a7c1cd328f08;0;4;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;57;1278.486,-397.6114;Inherit;False;Property;_EnableGlitch;Enable Glitch;129;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;109;1656.25,-345.9998;Inherit;False;_UberEffect;148;;2245;93c7a07f758a0814998210619e8ad1cb;0;3;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;77;2492.977,-348.4961;Inherit;False;Property;_EnableFullDistortion;Enable Full Distortion;339;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;75;3434.708,-336.5002;Inherit;False;Property;_EnableDirectionalDistortion;Enable Directional Distortion;326;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;87;3929.017,-74.64402;Inherit;False;_UberFading;260;;2327;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;2;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;128;4529.681,280.2438;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;117;4244.284,-85.79267;Inherit;False;_UberColorFinal;2;;2356;6ac57aba23ea6404ba71b6806ea93971;0;1;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;97;4200.187,769.8402;Inherit;False;_Squish;411;;2364;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.StaticSwitch;96;4490.183,668.8401;Inherit;False;Property;_EnableSquish;Enable Squish;410;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;132;5249.333,107.1116;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BreakToComponentsNode;133;5317.633,195.4364;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.FunctionNode;92;4760.852,615.6682;Inherit;False;_UberTransformOffset;382;;2365;ee5e9e731457b2342bdb306bdb8d2401;0;1;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;134;5699.575,56.34146;Inherit;False;3;0;FLOAT3;1,1,1;False;1;FLOAT3;1,1,1;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DynamicAppendNode;135;5894.318,173.2793;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;6293.496,426.7659;Float;False;True;-1;2;SpriteShadersUltimate.UberShaderGUI;0;8;Sprite Shaders Ultimate/Uber/Multiplicative Uber;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;6;2;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;True;2;False;-1;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;134;2;133;3
WireConnection;135;0;134;0
WireConnection;121;1;92;0
WireConnection;121;2;123;0
WireConnection;14;0;135;0
WireConnection;14;1;121;0
ASEEND*/
//CHKSM=0FD3EFB615A74FDDD730A2F500E2F80AC5CC169A
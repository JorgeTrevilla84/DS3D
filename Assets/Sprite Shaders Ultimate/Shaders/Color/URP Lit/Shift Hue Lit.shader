...
Shader "Sprite Shaders Ultimate/URP Lit/Color/Shift Hue Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_1_0_g38 = tex2D( _MainTex, uv_MainTex );
				float3 temp_output_34_0_g38 = (temp_output_1_0_g38).rgb;
				float mulTime31_g38 = _TimeParameters.x * _ShiftHueSpeed;
				float3 hsvTorgb15_g38 = RGBToHSV( temp_output_34_0_g38 );
				float3 hsvTorgb19_g38 = HSVToRGB( float3(( mulTime31_g38 + hsvTorgb15_g38.x ),hsvTorgb15_g38.y,hsvTorgb15_g38.z) );
				float2 uv_ShiftHueShaderMask = IN.texCoord0.xy * _ShiftHueShaderMask_ST.xy + _ShiftHueShaderMask_ST.zw;
				float4 tex2DNode3_g39 = tex2D( _ShiftHueShaderMask, uv_ShiftHueShaderMask );
				float3 lerpResult33_g38 = lerp( temp_output_34_0_g38 , hsvTorgb19_g38 , ( _ShiftHueFade * ( tex2DNode3_g39.r * tex2DNode3_g39.a ) ));
				float4 appendResult6_g38 = (float4(lerpResult33_g38 , temp_output_1_0_g38.a));
				
				float2 temp_output_8_0_g36 = IN.texCoord0.xy;
				
				float3 unpack14_g36 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g36 ), _NormalIntensity );
				unpack14_g36.z = lerp( 1, unpack14_g36.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult6_g38 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g36 ).r;
				float3 Normal = unpack14_g36;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult6_g38 * IN.color );
				float3 Normal = unpack14_g36;
...
/*ASEBEGIN
Version=18800
113;141;1338;608;1185.833;460.6199;1.555538;True;True
...
Node;AmplifyShaderEditor.FunctionNode;74;-14.51283,-175.9564;Inherit;False;_ShiftHue;5;;38;96c4ce2b4a870d842a5631d1a2ef1fe5;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;66;220.6745,159.7954;Inherit;False;LitHandler;1;;36;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;68;234.7509,-72.4296;Inherit;False;TintVertex;-1;;37;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Shift Hue Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=4D0942477D664EB07884659DF7512180D5FF8771
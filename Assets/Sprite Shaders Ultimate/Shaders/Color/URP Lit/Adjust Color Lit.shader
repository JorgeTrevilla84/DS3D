...
Shader "Sprite Shaders Ultimate/URP Lit/Color/Adjust Color Lit"
{
	Properties
	{
		...
		[ASEEnd]_AdjustColorHueShift("Adjust Color: Hue Shift", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break2_g27 = tex2D( _MainTex, uv_MainTex );
				float3 appendResult4_g27 = (float3(break2_g27.r , break2_g27.g , break2_g27.b));
				float3 hsvTorgb16_g27 = RGBToHSV( appendResult4_g27 );
				float clampResult18_g27 = clamp( ( hsvTorgb16_g27.y * _AdjustColorSaturation ) , 0.0 , 1.0 );
				float temp_output_9_0_g28 = max( _AdjustColorContrast , 0.0 );
				float3 hsvTorgb24_g27 = HSVToRGB( float3(( hsvTorgb16_g27.x + _AdjustColorHueShift ),clampResult18_g27,( pow( ( hsvTorgb16_g27.z + ( 0.1 * max( ( 1.0 - temp_output_9_0_g28 ) , 0.0 ) ) ) , temp_output_9_0_g28 ) * _AdjustColorBrightness )) );
				float3 lerpResult9_g27 = lerp( appendResult4_g27 , hsvTorgb24_g27 , _AdjustColorFade);
				float4 appendResult3_g27 = (float4(lerpResult9_g27 , break2_g27.a));
				
				float2 temp_output_8_0_g29 = IN.texCoord0.xy;
				
				float3 unpack14_g29 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g29 ), _NormalIntensity );
				unpack14_g29.z = lerp( 1, unpack14_g29.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult3_g27 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g29 ).r;
				float3 Normal = unpack14_g29;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult3_g27 * IN.color );
				float3 Normal = unpack14_g29;
...
/*ASEBEGIN
Version=18800
25;293;1338;706;1313.385;722.1143;1.634285;True;True
...
Node;AmplifyShaderEditor.FunctionNode;74;-23.61468,-213.5162;Inherit;False;_AdjustColor;5;;27;e7083192d13fe334cab64b3d59374f2b;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;66;220.6745,159.7954;Inherit;False;LitHandler;1;;29;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;68;234.7509,-72.4296;Inherit;False;TintVertex;-1;;30;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Adjust Color Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=F1E8EE8E08AA9F68E442FE29A4695BEB118C7DFF
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break2_g241 = temp_output_1_0_g238;
				float temp_output_9_0_g240 = max( _SineGlowContrast , 0.0 );
				float saferPower7_g240 = max( ( ( ( break2_g241.x + break2_g241.y + break2_g241.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g240 ) , 0.0 ) ) ) , 0.0001 );
				float2 uv_SineGlowShaderMask = IN.texCoord0.xy * _SineGlowShaderMask_ST.xy + _SineGlowShaderMask_ST.zw;
				float4 tex2DNode3_g239 = tex2D( _SineGlowShaderMask, uv_SineGlowShaderMask );
				float mulTime15_g238 = _TimeParameters.x * _SineGlowFrequency;
				float4 appendResult21_g238 = (float4(( (temp_output_1_0_g238).rgb + ( pow( saferPower7_g240 , temp_output_9_0_g240 ) * ( _SineGlowFade * ( tex2DNode3_g239.r * tex2DNode3_g239.a ) ) * (_SineGlowColor).rgb * ( ( ( sin( mulTime15_g238 ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g238.a));
				...
				float4 Color = ( appendResult21_g238 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult21_g238 * IN.color );
				float3 Normal = unpack14_g243;
...
/*ASEBEGIN
Version=18800
75;98;1331;566;840.0858;76.30273;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;93;-355.876,-14.40891;Inherit;False;_SineGlow;5;;238;07a37ab089b5b1946a9271fb928592ed;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=8AA736F9C1CDC498B1CB86B4869A1335E45152BF
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_15_0_g27 = tex2D( _MainTex, uv_MainTex );
				float2 temp_output_7_0_g27 = IN.texCoord0.xy;
				#ifdef _INNEROUTLINEDISTORTIONTOGGLE_ON
				float2 staticSwitch169_g27 = ( ( tex2D( _InnerOutlineNoiseTexture, ( ( ( _TimeParameters.x * _InnerOutlineNoiseSpeed ) + temp_output_7_0_g27 ) * _InnerOutlineNoiseScale ) ).r - 0.25 ) * _InnerOutlineDistortionIntensity );
				#else
				float2 staticSwitch169_g27 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g27 = ( staticSwitch169_g27 + temp_output_7_0_g27 );
				float2 appendResult2_g29 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_25_0_g27 = ( 100.0 / appendResult2_g29 );
				float temp_output_161_0_g27 = (temp_output_15_0_g27).a;
				float temp_output_151_0_g27 = ( ( _InnerOutlineColor.a * ( 1.0 - min( min( min( min( min( min( min( tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g27 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g27 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g27 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g27 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g27 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g27 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g27 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g27 + ( ( _InnerOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g27 ) ) ).a ) ) * temp_output_161_0_g27 ) * ( _InnerOutlineFade * min( ( _InnerOutlineWidth * 100.0 ) , 1.0 ) ) );
				float4 appendResult84_g27 = (float4((_InnerOutlineColor).rgb , temp_output_151_0_g27));
				float4 lerpResult43_g27 = lerp( temp_output_15_0_g27 , appendResult84_g27 , temp_output_151_0_g27);
				float4 appendResult162_g27 = (float4((lerpResult43_g27).xyz , temp_output_161_0_g27));
				...
				float4 Color = ( appendResult162_g27 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult162_g27 * IN.color );
				float3 Normal = unpack14_g30;
...
/*ASEBEGIN
Version=18800
4;547;1613;678;890.9131;364.9268;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;73;-65.06287,-158.8319;Inherit;False;_InnerOutline;5;;27;818398d5e9094b940bc7b20a41c33af2;0;4;15;COLOR;0,0,0,0;False;174;SAMPLER2D;;False;7;FLOAT2;0,0;False;4;SAMPLER2D;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Inner Outline Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;69;0;70;0
WireConnection;73;15;69;0
WireConnection;73;7;72;0
WireConnection;73;4;70;0
WireConnection;68;1;73;0
WireConnection;15;1;68;0
WireConnection;15;2;66;0
WireConnection;15;3;66;5
ASEEND*/
//CHKSM=3AF17B6689BF157D32D5B8FB93E32991E6C60F76
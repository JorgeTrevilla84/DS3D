	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_15_0_g23 = tex2D( _MainTex, uv_MainTex );
				float temp_output_31_0_g23 = (temp_output_15_0_g23).a;
				float2 temp_output_7_0_g23 = IN.texCoord0.xy;
				#ifdef _OUTEROUTLINEDISTORTIONTOGGLE_ON
				float2 staticSwitch157_g23 = ( ( tex2D( _OuterOutlineNoiseTexture, ( ( ( _TimeParameters.x * _OuterOutlineNoiseSpeed ) + temp_output_7_0_g23 ) * _OuterOutlineNoiseScale ) ).r - 0.25 ) * _OuterOutlineDistortionIntensity );
				#else
				float2 staticSwitch157_g23 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g23 = ( staticSwitch157_g23 + temp_output_7_0_g23 );
				float2 appendResult2_g24 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_25_0_g23 = ( 100.0 / appendResult2_g24 );
				float temp_output_83_0_g23 = ( _OuterOutlineColor.a * min( ( max( max( max( max( max( max( max( tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g23 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g23 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g23 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g23 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g23 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g23 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g23 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g23 + ( ( _OuterOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g23 ) ) ).a ) * 3.0 ) , 1.0 ) );
				float lerpResult152_g23 = lerp( temp_output_31_0_g23 , temp_output_83_0_g23 , ( temp_output_83_0_g23 * _OuterOutlineFade ));
				float4 appendResult84_g23 = (float4((_OuterOutlineColor).rgb , lerpResult152_g23));
				float4 lerpResult43_g23 = lerp( appendResult84_g23 , temp_output_15_0_g23 , ( 1.0 - ( min( ( _OuterOutlineFade * 10.0 ) , 1.0 ) * ( 1.0 - temp_output_31_0_g23 ) ) ));
				...
				float4 Color = ( lerpResult43_g23 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( lerpResult43_g23 * IN.color );
				float3 Normal = unpack14_g26;
...
/*ASEBEGIN
Version=18800
-75;528;1613;612;1048.288;228.116;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;71;-64.24355,-194.9285;Inherit;False;_OuterOutline;5;;23;c63fd6271f1306b46aa2076a150659b5;0;4;15;COLOR;0,0,0,0;False;161;SAMPLER2D;;False;7;FLOAT2;0,0;False;4;SAMPLER2D;0;False;1;COLOR;0
...
WireConnection;71;15;69;0
WireConnection;71;7;72;0
...
ASEEND*/
//CHKSM=2E40C36ABB98265C26574A4AC08B6756AFBDC6DB
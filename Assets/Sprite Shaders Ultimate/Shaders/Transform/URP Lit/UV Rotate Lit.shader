...
Shader "Sprite Shaders Ultimate/URP Lit/Transform/UV Rotate Lit"
{
	Properties
	{
		...
		[ASEEnd]_NormalIntensity("Normal Intensity", Range( 0 , 3)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float mulTime6_g24 = _TimeParameters.x * _UVRotateSpeed;
				float3 rotatedValue8_g24 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( IN.texCoord0.xy ,  0.0 ), float3( 0,0,1 ), ( mulTime6_g24 * PI ) );
				float2 temp_output_73_0 = ( ( ( (rotatedValue8_g24).xy - float2( 0.5,0.5 ) ) / max( _UVRotateScale , 0.01 ) ) + float2( 0.5,0.5 ) );
...
/*ASEBEGIN
Version=18800
334;56;1338;650;1013.212;416.1401;1.208987;True;True
...
Node;AmplifyShaderEditor.FunctionNode;73;-724.2811,-89.85615;Inherit;False;_UVRotate;0;;24;b33a464c10c1c9946bcc807697ca7b43;0;1;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;66;23.38802,234.6282;Inherit;False;LitHandler;2;;22;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Transform/UV Rotate Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=609CFA793CB6030037B85A85A730E8173F215C5F
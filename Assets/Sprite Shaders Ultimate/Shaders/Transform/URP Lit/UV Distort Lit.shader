...
Shader "Sprite Shaders Ultimate/URP Lit/Transform/UV Distort Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult2_g40 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g39 = 0;
				if( _UVDistortSpace > 1.0 )
				ifLocalVar2_g39 = (ase_worldPos).xy;
				else if( _UVDistortSpace == 1.0 )
				ifLocalVar2_g39 = (IN.ase_texcoord4.xyz).xy;
				else if( _UVDistortSpace < 1.0 )
				ifLocalVar2_g39 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g40 ) );
				float2 lerpResult21_g38 = lerp( _UVDistortFrom , _UVDistortTo , tex2D( _UVDistortNoiseTexture, ( ( ifLocalVar2_g39 + ( _UVDistortSpeed * _TimeParameters.x ) ) * _UVDistortNoiseScale ) ).r);
				float2 appendResult2_g42 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 uv_UVDistortShaderMask = IN.texCoord0.xy * _UVDistortShaderMask_ST.xy + _UVDistortShaderMask_ST.zw;
				float4 tex2DNode3_g41 = tex2D( _UVDistortShaderMask, uv_UVDistortShaderMask );
				float2 temp_output_74_0 = ( IN.texCoord0.xy + ( lerpResult21_g38 * ( 100.0 / appendResult2_g42 ) * ( _UVDistortFade * ( tex2DNode3_g41.r * tex2DNode3_g41.a ) ) ) );
				
				float2 temp_output_8_0_g44 = temp_output_74_0;
				...
				float4 Color = ( tex2D( _MainTex, temp_output_74_0 ) * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g39 = (IN.ase_texcoord6.xyz).xy;
				else if( _UVDistortSpace < 1.0 )
				ifLocalVar2_g39 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g40 ) );
				float2 lerpResult21_g38 = lerp( _UVDistortFrom , _UVDistortTo , tex2D( _UVDistortNoiseTexture, ( ( ifLocalVar2_g39 + ( _UVDistortSpeed * _TimeParameters.x ) ) * _UVDistortNoiseScale ) ).r);
				float2 appendResult2_g42 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				...
				float4 Color = ( tex2D( _MainTex, temp_output_74_0 ) * IN.color );
				float3 Normal = unpack14_g44;
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g39 = (IN.ase_texcoord3.xyz).xy;
				else if( _UVDistortSpace < 1.0 )
				ifLocalVar2_g39 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g40 ) );
				float2 lerpResult21_g38 = lerp( _UVDistortFrom , _UVDistortTo , tex2D( _UVDistortNoiseTexture, ( ( ifLocalVar2_g39 + ( _UVDistortSpeed * _TimeParameters.x ) ) * _UVDistortNoiseScale ) ).r);
				float2 appendResult2_g42 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
...
/*ASEBEGIN
Version=18800
80;40;1331;672;482.6378;136.7255;1;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;69;-981.4686,-450.4729;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;74;-703.3858,-55.31476;Inherit;False;_UVDistort;5;;38;d6b8c102b9317a0418c08eb00598bec7;0;3;1;FLOAT2;0,0;False;26;SAMPLER2D;;False;3;SAMPLER2D;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;68;-421.0153,-281.8196;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;66;23.38802,234.6282;Inherit;False;LitHandler;1;;44;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;67;-5.284546,-87.48749;Inherit;False;TintVertex;-1;;45;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Transform/UV Distort Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;74;1;71;0
WireConnection;74;3;69;0
WireConnection;68;0;69;0
WireConnection;68;1;74;0
WireConnection;66;8;74;0
WireConnection;67;1;68;0
WireConnection;15;1;67;0
WireConnection;15;2;66;0
WireConnection;15;3;66;5
ASEEND*/
//CHKSM=FE99C065E96361558FB020BA86ABA28021EB7ED6
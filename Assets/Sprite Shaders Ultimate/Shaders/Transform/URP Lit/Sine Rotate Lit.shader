...
Shader "Sprite Shaders Ultimate/URP Lit/Transform/Sine Rotate Lit"
{
	Properties
	{
		...
		[ASEEnd]_SineRotateScale("Sine Rotate: Scale", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float mulTime43_g27 = _TimeParameters.x * _SineRotateFrequency;
				float3 rotatedValue36_g27 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( IN.texCoord0.xy ,  0.0 ), float3( 0,0,1 ), ( sin( mulTime43_g27 ) * ( ( _SineRotateAngle / 360.0 ) * PI ) * _SineRotateFade ) );
				float2 temp_output_74_41 = ( ( ( (rotatedValue36_g27).xy - float2( 0.5,0.5 ) ) / max( _SineRotateScale , 0.01 ) ) + float2( 0.5,0.5 ) );
				
				float2 temp_output_8_0_g28 = temp_output_74_41;
				
				float3 unpack14_g28 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g28 ), _NormalIntensity );
				unpack14_g28.z = lerp( 1, unpack14_g28.z, saturate(_NormalIntensity) );
				
				float4 Color = ( tex2D( _MainTex, temp_output_74_41 ) * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g28 ).r;
				float3 Normal = unpack14_g28;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( tex2D( _MainTex, temp_output_74_41 ) * IN.color );
				float3 Normal = unpack14_g28;
...
/*ASEBEGIN
Version=18800
193;233;1338;614;985.459;294.9873;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;74;-756.4595,-160.4873;Inherit;False;_SineRotate;5;;27;af2def15ac77365459ed5b387b6227d9;0;1;32;FLOAT2;0,0;False;1;FLOAT2;41
...
Node;AmplifyShaderEditor.FunctionNode;66;23.38802,234.6282;Inherit;False;LitHandler;1;;28;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;67;-5.284546,-87.48749;Inherit;False;TintVertex;-1;;29;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Transform/Sine Rotate Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;74;32;71;0
WireConnection;68;0;69;0
WireConnection;68;1;74;41
WireConnection;66;8;74;41
WireConnection;67;1;68;0
WireConnection;15;1;67;0
WireConnection;15;2;66;0
WireConnection;15;3;66;5
ASEEND*/
//CHKSM=897441D7F63AD4346F2C3073FC1969DB9A2879A6
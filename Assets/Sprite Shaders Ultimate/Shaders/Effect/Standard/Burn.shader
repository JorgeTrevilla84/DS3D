...
Shader "Sprite Shaders Ultimate/Standard/Effect/Burn"
{
	Properties
	{
		...
		_BurnNoiseTexture("Burn: Noise Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 appendResult2_g406 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g405 = 0;
				if( (int)_BurnSpace > 1.0 )
				ifLocalVar2_g405 = (ase_worldPos).xy;
				else if( (int)_BurnSpace == 1.0 )
				ifLocalVar2_g405 = (IN.ase_texcoord2.xyz).xy;
				else if( (int)_BurnSpace < 1.0 )
				ifLocalVar2_g405 = ( IN.texcoord.xy / ( 100.0 / appendResult2_g406 ) );
				float2 temp_output_3_0_g401 = ifLocalVar2_g405;
				float clampResult68_g401 = clamp( ( _BurnInsideNoiseFactor - tex2D( _BurnNoiseTexture, ( ( ( ( tex2D( _BurnNoiseTexture, ( temp_output_3_0_g401 * _BurnSwirlNoiseScale ) ).r - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_3_0_g401 ) * _BurnInsideNoiseScale ) ).r ) , 0.0 , 1.0 );
				float temp_output_15_0_g401 = ( ( ( _BurnRadius - distance( temp_output_3_0_g401 , _BurnPosition ) ) + ( tex2D( _BurnNoiseTexture, ( temp_output_3_0_g401 * _BurnEdgeNoiseScale ) ).r * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
...
/*ASEBEGIN
Version=18800
347;644;1613;684;1501.87;311.9372;1.370293;True;True
...
Node;AmplifyShaderEditor.FunctionNode;127;-360.865,-18.34382;Inherit;False;_Burn;0;;401;de4c95c84e2e52a42b58ba01b39442ae;0;3;2;SAMPLER2D;0;False;71;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;22;-63.6362,70.99575;Inherit;False;TintVertex;-1;;400;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;81;211.4418,70.685;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;8;Sprite Shaders Ultimate/Standard/Effect/Burn;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;3;1;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;True;2;False;-1;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
WireConnection;24;0;106;0
WireConnection;127;2;106;0
WireConnection;127;1;24;0
WireConnection;22;1;127;0
WireConnection;81;0;22;0
ASEEND*/
//CHKSM=4B66C119EBCA3BC4A3EDC266FE6C5759B3EB8095
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult2_g236 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 ifLocalVar2_g235 = 0;
				if( (int)_BurnSpace > 1.0 )
				ifLocalVar2_g235 = (ase_worldPos).xy;
				else if( (int)_BurnSpace == 1.0 )
				ifLocalVar2_g235 = (IN.ase_texcoord4.xyz).xy;
				else if( (int)_BurnSpace < 1.0 )
				ifLocalVar2_g235 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g236 ) );
				float2 temp_output_3_0_g231 = ifLocalVar2_g235;
				float clampResult68_g231 = clamp( ( _BurnInsideNoiseFactor - tex2D( _BurnNoiseTexture, ( ( ( ( tex2D( _BurnNoiseTexture, ( temp_output_3_0_g231 * _BurnSwirlNoiseScale ) ).r - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_3_0_g231 ) * _BurnInsideNoiseScale ) ).r ) , 0.0 , 1.0 );
				float temp_output_15_0_g231 = ( ( ( _BurnRadius - distance( temp_output_3_0_g231 , _BurnPosition ) ) + ( tex2D( _BurnNoiseTexture, ( temp_output_3_0_g231 * _BurnEdgeNoiseScale ) ).r * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g235 = (IN.ase_texcoord6.xyz).xy;
				else if( (int)_BurnSpace < 1.0 )
				ifLocalVar2_g235 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g236 ) );
				float2 temp_output_3_0_g231 = ifLocalVar2_g235;
				float clampResult68_g231 = clamp( ( _BurnInsideNoiseFactor - tex2D( _BurnNoiseTexture, ( ( ( ( tex2D( _BurnNoiseTexture, ( temp_output_3_0_g231 * _BurnSwirlNoiseScale ) ).r - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_3_0_g231 ) * _BurnInsideNoiseScale ) ).r ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				ifLocalVar2_g235 = (IN.ase_texcoord3.xyz).xy;
				else if( (int)_BurnSpace < 1.0 )
				ifLocalVar2_g235 = ( IN.texCoord0.xy / ( 100.0 / appendResult2_g236 ) );
				float2 temp_output_3_0_g231 = ifLocalVar2_g235;
				float clampResult68_g231 = clamp( ( _BurnInsideNoiseFactor - tex2D( _BurnNoiseTexture, ( ( ( ( tex2D( _BurnNoiseTexture, ( temp_output_3_0_g231 * _BurnSwirlNoiseScale ) ).r - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_3_0_g231 ) * _BurnInsideNoiseScale ) ).r ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18800
-109;664;1613;684;1410.542;372.0418;1.3;True;True
...
Node;AmplifyShaderEditor.FunctionNode;92;-388.9785,-84.65247;Inherit;False;_Burn;5;;231;de4c95c84e2e52a42b58ba01b39442ae;0;3;2;SAMPLER2D;0;False;71;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;83;211.4418,70.685;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Effect/Burn Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=1CC0794BDE12ED413E81E6F9369EF6E8AEB0D535
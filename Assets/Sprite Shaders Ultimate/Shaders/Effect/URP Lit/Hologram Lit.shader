	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_8_0_g329 = ( ( ( _TimeParameters.x * _HologramDistortionSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y );
				float2 temp_cast_0 = (temp_output_8_0_g329).xx;
				float2 temp_cast_1 = (_HologramDistortionDensity).xx;
				float clampResult75_g329 = clamp( tex2D( _HologramNoiseTexture, ( temp_cast_0 * temp_cast_1 ) ).r , 0.075 , 0.6 );
				float2 temp_cast_2 = (temp_output_8_0_g329).xx;
				float2 temp_cast_3 = (_HologramDistortionScale).xx;
				float2 appendResult2_g330 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult44_g329 = (float2(( ( ( clampResult75_g329 * ( tex2D( _HologramNoiseTexture, ( temp_cast_2 * temp_cast_3 ) ).r - 0.25 ) ) * _HologramDistortionOffset * ( 100.0 / appendResult2_g330 ).x ) * _HologramFade ) , 0.0));
				float4 temp_output_1_0_g333 = tex2D( _MainTex, ( IN.texCoord0.xy + appendResult44_g329 ) );
				float4 break2_g334 = temp_output_1_0_g333;
				float temp_output_9_0_g335 = max( _HologramContrast , 0.0 );
				float saferPower7_g335 = max( ( ( ( break2_g334.x + break2_g334.y + break2_g334.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g335 ) , 0.0 ) ) ) , 0.0001 );
				float4 appendResult22_g333 = (float4(( (_HologramTint).rgb * pow( saferPower7_g335 , temp_output_9_0_g335 ) ) , ( max( pow( abs( sin( ( ( ( ( _TimeParameters.x * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g333.a )));
				float4 lerpResult37_g333 = lerp( temp_output_1_0_g333 , appendResult22_g333 , _HologramFade);
				...
				float4 Color = ( lerpResult37_g333 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( lerpResult37_g333 * IN.color );
				float3 Normal = unpack14_g337;
...
/*ASEBEGIN
Version=18800
-123;763;1613;702;2017.779;278.3418;1.215731;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;90;-1419.446,-516.6273;Inherit;False;Property;_HologramFade;Hologram: Fade;5;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;91;-1145.167,-20.02304;Inherit;False;_HologramUV;13;;329;7c71b1b031ffcbe48805e17b94671163;0;4;55;FLOAT;0;False;76;SAMPLER2D;;False;37;FLOAT2;0,0;False;39;SAMPLER2D;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;93;-469.3445,-158.609;Inherit;False;_Hologram;6;;333;76082a965d84d0e4da33b2cff51b3691;0;2;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;83;211.4418,70.685;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Effect/Hologram Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
WireConnection;91;55;90;0
WireConnection;91;37;88;0
WireConnection;91;39;89;0
WireConnection;92;0;89;0
WireConnection;92;1;91;0
WireConnection;93;40;90;0
...
ASEEND*/
//CHKSM=0AB5467758319F8DD256830EF059CD6D4D10C428
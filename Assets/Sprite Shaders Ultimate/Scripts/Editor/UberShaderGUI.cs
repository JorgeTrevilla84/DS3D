    ...
    public class UberShaderGUI : ShaderGUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            else if (shader.name.EndsWith("UI Uber"))
            {
                ...
                extraLine2 = "- You may need to press [<b>Control + S</b>] to update material changes.";
            }
            ...
            if (GUILayout.Button(hintUber ? "Collapse" : "Expand", GUILayout.Width(80)))
            {
                hintUber = !hintUber;
            }
            GUI.color = Color.white;
            ...
            if (hintUber)
            {
                EditorGUILayout.LabelField("Simply enable all the shaders you want to use on this material.", style);
                EditorGUILayout.LabelField("Only enabled shaders will be compiled into your build.", style);
                EditorGUILayout.Space();
                EditorGUILayout.LabelField("Runtime toggling of shaders through keywords should be avoided.", style);
                EditorGUILayout.LabelField("Instead use the <b>Fade</b> property to conditionally show shaders.", style);
            }
